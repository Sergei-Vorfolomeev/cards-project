                ...
                <TableHead sx={{background: '#EFEFEF'}}>
                    <TableRow>
                        {columnsData.map((columnData, index) => (
                            <TableCell sx={{fontWeight: '700', cursor: 'pointer', maxWidth: '145px'}} align="center"
                                       key={index}>
                                <TableSortLabel
                ...
                <TableBody>
                    {rows.map((row, index) => (
                        <TableRow key={index} sx={{'&:last-child td, &:last-child th': {border: 0}}}>
                            <TableCell sx={{maxWidth: '145px', overflow: 'hidden'}}
                                       align="center">{row.question}</TableCell>
                            <TableCell sx={{maxWidth: '145px', overflow: 'hidden'}}
                                       align="center">{row.answer}</TableCell>
